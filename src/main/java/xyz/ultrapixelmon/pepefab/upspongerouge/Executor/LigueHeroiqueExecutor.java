...
public class LigueHeroiqueExecutor implements CommandExecutor{
    ...
    public CommandResult execute (CommandSource src, CommandContext args) throws CommandException{
        ...
        Sponge.getCommandManager().process(Sponge.getServer().getConsole(), "lp user " + pseudotarget + " meta addsuffix 11 &c?");
